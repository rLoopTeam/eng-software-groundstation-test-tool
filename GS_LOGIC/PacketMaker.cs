...
namespace GS_LOGIC
{
    public class PacketMaker
    {
        ...
        public byte[] makeUDP(PacketTypes type, int[][] values)
        {
            ...
            int packetTypeSize = 2;
            int payloadLengthDef = 2;
            int payloadLengthSize = 0;
            int crcSize = 2;
            int packetSize = sequenceSize + packetTypeSize + payloadLengthDef + crcSize;
            ...
            {
                payloadLengthSize += values[i][0];
            }

            packetSize += payloadLengthSize;

            byte[] packet = new byte[packetSize];
            byte[] payload = new byte[payloadLengthSize];
            int payloadPos = 0;
        ...
        */
        ...
        static class CRC
        {
            public static UInt16[] Hashtable = new UInt16[]
           {
